...
import { dispatchLogIn } from '../state/main/actions';
import { useSelector, useDispatch } from 'react-redux';
import { useRouter } from 'next/router';
import { selectLogInError, selectLogInErrMsg, addNotification } from '../state/main/mainSlice';
...
export default function SignInSide() {
    ...
    const onLogInClick = async () => {
        ...
        if (validForm) {
            ...
            dispatcher(addNotification({ content: 'Invalid form data', color: 'error' }));
        }
    };
